...
<%
	...
	String path = "C:\\iclass\\upload";	//파일 업로드 경로
							//서버의 업로드 경로에 대해 url 지정이 필요합니다. server.xml
	int size = 10*1024*1024;  //10MByte, 전송파일의 최대 크기
	
	MultipartRequest multiRequest = new MultipartRequest(
			request,path,size,"UTF-8",
			new DefaultFileRenamePolicy());
	//DefaultFileRenamePolicy 객체 : 업로드한 파일명이 중복될 경우 파일명 변경하는 정책을 설정.
	//				ㄴ해쉬값(랜덤문자열) 이용하거나 업로드 날짜시간을 이용해서 파일명을  변경할 수 있습니다.
