...
<main>
		...
		<ul id="main">
			...
			<li>
				<ul style="display: flex;">
					...
					<!-- sessionScope.user는 session에 저장된 애트리뷰트 user를 가져옵니다.
						sessionScope을 생략할 수 있지만 request, application등 다른 영역에 중복된 이름이 있을 때응 
						고려하여 명시적으로 지정합니다.
						  -->
	...
	function login(){
		...
		//다시 지금 페이지로 돌아오기 위해 필요한 값 mref,page 요소값을 전달. (textarea는 불필요)
